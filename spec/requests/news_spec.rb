  ...
  describe 'GET List News' do
    ...
    context 'without pagination param' do
      ...
      it 'fetchs data correct page' do
        expect(URI).to receive(:open).with(URI.encode('https://news.ycombinator.com/best?p=1'), 'User-Agent' => 'Hackernews')
    ...
    context 'with pagination param' do
      ...
      it 'fetchs data correct page' do
        expect(URI).to receive(:open).with(URI.encode('https://news.ycombinator.com/best?p=2'), 'User-Agent' => 'Hackernews')
